    ...
    try:
        ...
        if code != 0:
            ...
            for i in data:
                for w in i["cw"]:
                    result += w["w"]
            # print(f"on_message result: {result}")
...
def extract_audio(video_path):
    ...
    # 构建输出音频文件路径
    output_audio_path = os.path.join(video_dir, 'video_audio.mp3')
...
if __name__ == "__main__":
    # 测试时候在此处正确填写相关信息即可运行
    video_file_path = r'/Users/youlan/Pictures/private/M4ROOT/CLIP/23年思政学风会议+采访/采访主机位-35mm-主声音/20231222_A0554.MP4'
