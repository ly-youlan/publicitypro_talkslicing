...
from TalkAutomation.gpt import emo_gpt


class HonorShortEngine(ContentShortEngine):
    ...
    def _generateScript(self):
        ...
        self._db_script = emo_gpt.genreateEmoStory()
        # print(f"in _short_engine: got script from gpt.py: {self._db_script}")#debug
