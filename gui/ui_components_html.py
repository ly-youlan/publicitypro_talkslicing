class GradioComponentsHTML:
    ...
    def get_html_header() -> str:
        ...
        return '''
            ...
            <h1 style="margin-left: 0px; font-size: 35px;">公众力PRO</h1>
            <div style="flex-grow: 1; text-align: right;">
                <a href="https://youlan.notion.site/Invite-Letter-To-You-b608fc6f4e984dbea7d3bbfbfd3284b3?pvs=4" target="_blank" style="text-decoration: none;">
                <button style="padding: 10px 20px; font-size: 16px; color: #fff; background-color: #333; border: none; border-radius: 5px; cursor: pointer;">加入我们，一起落地 ⭐</button>
                </a>
            </div>
            </div>
        '''
